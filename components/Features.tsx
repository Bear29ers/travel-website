...
const FeatureItem: FC<FeatureItem> = ({ title, icon, description }) => {
  return (
...
const Features: FC = () => {
  return (
    <section className="flexCenter flex-col overflow-hidden border-2 border-red-500 bg-feature-bg bg-no-repeat py-24">
